...
public class Location {
	...
	private static final double SCALE_LAT = 111.0; // one degree than has this many kelometers
	...
	public static void main(String[] args) {
		...
		trie.add("aroha ave", new Road(0,0,"aroha ave", "", 0,0,0,0,0,0));
		
		
		List<Road> all = trie.getAll("aroha ave");
		
		System.out.println(all.get(0).getRoadName());
	}
}
